...
const i18n = {
  en: {
    ...
    home_gate_copy: "Pick the track that matches your outcome.",
    home_founder_short: "Investor demos and first MVP versions built fast.",
    home_tools_short: "Dashboards, workflows, and practical automation tools.",
    home_interactive_short: "Unreal and VR prototypes for interactive and simulation builds.",
    ...
    founder_lead:
      "Built for founders who need a practical first version they can show, test, and iterate quickly with real feedback. Lighthouse is one of the product tracks I built this way.",
    ...
    founder_build_3: "Validation-first social and discovery loops",
    founder_build_4: "Practical MVP slices with privacy and trust controls",
    ...
    founder_example_title_1: "Core social surface shipped early for investor and user walkthroughs",
    founder_example_body_1:
      "Implemented feed, story rail, and quick post composer so the product felt usable in first demos, not just described in slides.",
    founder_example_chip_2: "Nearby Discovery",
    founder_example_title_2: "People-nearby cards that turn discovery into immediate actions",
    ...
    founder_example_title_3: "Map-backed people view for location-aware social context",
    founder_example_body_3:
      "Prototype flow linked presence visibility and people search so users could discover contacts without exposing precise location data.",
    founder_example_chip_4: "Engagement Loop",
    founder_example_title_4: "Post interaction flow designed for repeat usage signals",
    founder_example_body_4:
      "Structured post cards with reactions and save actions to validate whether early users return and keep interacting.",
    ...
    tools_example_title_1: "Inventory, viewport, and runtime chat in one operational surface",
    ...
    tools_example_title_2: "Widget editing workflow with immediate visual verification",
    ...
    tools_example_title_3: "Operator-friendly controls for fast simulation adjustments",
    ...
    contact_panel_copy: "Email for detailed briefs. WhatsApp for faster coordination.",
    ...
    founder_examples_title: "Lighthouse product slices used to validate adoption, trust, and daily engagement quickly.",
    tools_examples_eyebrow: "Examples",
    tools_examples_title: "AGE Creator Console work focused on internal speed, consistency, and QA visibility.",
    ...
    contact_widget_title: "Tell me what you need",
    contact_widget_copy: "Share the goal, users, and timeline.",
    ...
    contact_widget_message_placeholder: "Goal, users, timeline, and must-have flow",
    ...
    footer_text: "Larion Siments | MVPs, Internal Tools, Interactive Prototypes",
  },
  he: {
    nav_home: "בית",
    ...
    home_gate_copy: "בחרו את המסלול שמתאים לתוצאה שלכם.",
    home_founder_short: "דמואים למשקיעים וגרסאות MVP ראשונות במהירות.",
    home_tools_short: "דשבורדים, תהליכי עבודה וכלי אוטומציה פרקטיים.",
    home_interactive_short: "פרוטוטייפים ב-Unreal ו-VR לבניות אינטראקטיביות וסימולציה.",
    ...
    founder_lead:
      "מתאים ליזמים שצריכים גרסה ראשונה פרקטית שאפשר להציג, לבדוק עם משתמשים ולשפר מהר. Lighthouse הוא אחד ממסלולי המוצר שבניתי בגישה הזאת.",
    ...
    founder_build_3: "לולאות ולידציה חברתיות וזרימות גילוי",
    founder_build_4: "חלקי MVP פרקטיים עם בקרות פרטיות ואמון",
    ...
    founder_example_chip_1: "Lighthouse Feed + Stories",
    founder_example_title_1: "משטח חברתי מרכזי שיצא מוקדם להצגות למשקיעים ולמשתמשים",
    founder_example_body_1: "מימשתי פיד, סטוריז וקומפוזר מהיר לפוסט כדי שהמוצר ירגיש עובד כבר בדמו הראשון.",
    founder_example_chip_2: "גילוי אנשים בקרבת מקום",
    founder_example_title_2: "כרטיסי אנשים בקרבת מקום שהופכים גילוי לפעולה מיידית",
    founder_example_body_2: "נבנו הצעות nearby עם פעולות חברות מהירות כדי לבדוק מעבר מצפייה לחיבור אמיתי בין אנשים.",
    founder_example_chip_3: "מפת אנשים",
    founder_example_title_3: "תצוגת מפה לאנשים עם הקשר מיקום אבל בלי חשיפת יתר",
    founder_example_body_3: "הפרוטוטייפ חיבר בין נראות נוכחות וחיפוש אנשים כך שניתן לגלות קשרים בלי לחשוף מיקום מדויק.",
    founder_example_chip_4: "לולאת מעורבות",
    founder_example_title_4: "זרימת אינטראקציה בפוסטים שנועדה למדוד חזרה ושימוש מתמשך",
    founder_example_body_4: "כרטיסי פוסטים עם ריאקשנים ושמירה נבנו כדי למדוד אם משתמשים מוקדמים חוזרים וממשיכים לפעול.",
    ...
    tools_example_chip_1: "Creator Console",
    tools_example_title_1: "משטח תפעולי אחד שמרכז אינבנטורי, viewport וצ'אט runtime",
    tools_example_body_1: "ב-AGE קונסולת היוצר איחדה דפדפן תוכן, חלון סימולציה וצ'אט סוכן כדי לעבוד בלי קפיצות הקשר.",
    tools_example_chip_2: "LiveUI Editor",
    tools_example_title_2: "זרימת עריכת ווידג'טים עם אימות חזותי מיידי",
    tools_example_body_2: "זרימת LiveUI מאפשרת עריכת רכיבי ממשק, תצוגה מיידית ושמירה על התאמה לחוזי state משותפים.",
    tools_example_chip_3: "Viewport Controls",
    tools_example_title_3: "בקרות ידידותיות למפעיל לשינויים מהירים בסימולציה",
    tools_example_body_3: "בקרות drag/rotate/scale ומתגי איכות נחשפו לאיטרציה מהירה שמתאימה למקלדת ולתהליכי QA.",
    ...
    contact_panel_copy: "אימייל מתאים למפרטים מפורטים. וואטסאפ מתאים לתיאום מהיר.",
    ...
    founder_examples_title: "חלקי מוצר מתוך Lighthouse ששימשו לוולידציה מהירה של אימוץ, אמון ומעורבות יומית.",
    tools_examples_eyebrow: "דוגמאות",
    tools_examples_title: "דוגמאות מ-AGE Creator Console שממוקדות במהירות פנימית, עקביות ובקרת QA.",
    ...
    contact_widget_title: "ספרו לי מה צריך לבנות",
    contact_widget_copy: "שתפו מטרה, משתמשים ולוח זמנים.",
    ...
    contact_widget_message_placeholder: "מטרה, משתמשים, לוח זמנים וזרימת ליבה",
    ...
    footer_text: "לריון סימנטס | MVP, כלים פנימיים, פרוטוטייפים אינטראקטיביים",
  },
};
