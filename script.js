...
const i18n = {
  en: {
    ...
    home_gate_copy: "Three lanes. Choose the one that fits the kind of build you need.",
    home_founder_short: "Investor demos, validation builds, and first MVP versions.",
    home_tools_short: "Dashboards, team workflows, and useful automation systems.",
    home_interactive_short: "Unreal, VR, and real-time prototypes built around interaction.",
  ...
  he: {
    ...
    home_gate_copy: "שלושה מסלולים. בחרו את זה שמתאים לסוג הבנייה שאתם צריכים.",
    home_founder_short: "דמואים למשקיעים, בניות ולידציה וגרסאות MVP ראשונות.",
    home_tools_short: "דשבורדים, תהליכי צוות ומערכות אוטומציה שימושיות.",
    home_interactive_short: "Unreal, VR ופרוטוטייפים בזמן אמת סביב אינטראקציה.",
