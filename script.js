...
const i18n = {
  en: {
    ...
    contact_panel_eyebrow: "Contact at a glance",
    contact_panel_title: "Pick the channel that fits your pace.",
    contact_panel_copy:
      "Email is best for detailed briefs. WhatsApp is better for quick back-and-forth. LinkedIn is there if you want context first.",
    contact_channel_email_label: "Email",
    contact_channel_email_note: "Best for briefs, specs, and attachments",
    contact_channel_whatsapp_label: "WhatsApp Israel",
    contact_channel_whatsapp_note: "Quick questions and follow-up",
    contact_channel_thailand_label: "WhatsApp Thailand",
    contact_channel_thailand_note: "Good if you're reaching me from Bangkok time",
    contact_channel_linkedin_label: "LinkedIn",
    contact_channel_linkedin_note: "Background and experience",
    contact_panel_help_eyebrow: "What helps",
    contact_panel_help_1: "A rough goal or outcome",
    contact_panel_help_2: "Any references, screenshots, or notes",
    contact_panel_help_3: "Which lane fits best: MVP, tools, or immersive",
  ...
  he: {
    ...
    contact_panel_eyebrow: "יצירת קשר במבט מהיר",
    contact_panel_title: "בחרו את הערוץ שמתאים לקצב שלכם.",
    contact_panel_copy:
      "אימייל מתאים למפרטים מפורטים. וואטסאפ טוב לשאלות קצרות ולהמשך שיחה. לינקדאין מתאים אם תרצו קודם קצת הקשר.",
    contact_channel_email_label: "אימייל",
    contact_channel_email_note: "טוב למפרטים, קבצים ונספחים",
    contact_channel_whatsapp_label: "וואטסאפ ישראל",
    contact_channel_whatsapp_note: "לשאלות קצרות ולהמשך שיחה",
    contact_channel_thailand_label: "וואטסאפ תאילנד",
    contact_channel_thailand_note: "מצוין אם אתם פונים אליי לפי שעון בנגקוק",
    contact_channel_linkedin_label: "לינקדאין",
    contact_channel_linkedin_note: "רקע וניסיון",
    contact_panel_help_eyebrow: "מה עוזר",
    contact_panel_help_1: "מטרה או תוצאה כללית",
    contact_panel_help_2: "הפניות, צילומי מסך או הערות",
    contact_panel_help_3: "איזה מסלול מתאים: MVP, כלים או אימרסיבי",
